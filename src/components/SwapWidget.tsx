  ...
  return (
    <Card className="w-[380px] bg-neutral-950/80 backdrop-blur-md border-white/10 shadow-black/40">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="icon"
              className="rounded-lg h-8 w-8 text-white/80 border-white/20"
            >
              <svg
                width="16"
                height="16"
                ...
                strokeWidth="1.5"
              >
                <path d="M3 12a9 9 0 0115.54-5.54M21 12a9 9 0 01-15.54 5.54" />
                <path d="M3 3v6h6" />
              </svg>
            </Button>
            <Button
      ...
      <CardContent className="space-y-4">
        ...
        <Button
          disabled
          className="w-full h-11 rounded-xl bg-white/10 text-white/70 hover:bg-white/10"
        >
          Enter amounts
        </Button>
      </CardContent>
